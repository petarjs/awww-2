<template>
  <section class="container mx-auto">
    ...
    <div class="leading-normal">
      <h1 class="text-4xl mb-8">Privacy Policy</h1>

      <p class="mb-6">This privacy policy has been compiled to better serve those who are concerned with how their 'Personally Identifiable Information' (PII) is being used online. PII, as described in US privacy law and information security, is information that can be used on its own or with other information to identify, contact, or locate a single person, or to identify an individual in context. Please read our privacy policy carefully to get a clear understanding of how we collect, use, protect or otherwise handle your Personally Identifiable Information in accordance with our website.</p>

      <h2 class="text-lg font-bold mb-4">What personal information do we collect from the people that visit our blog, website or app?</h2>

      <p class="mb-6">When ordering or registering on our site, as appropriate, you may be asked to enter your name, email address, mailing address or other details to help you with your experience.</p>

      <h2 class="text-lg font-bold mb-4">When do we collect information?</h2>

      <p class="mb-6">We collect information from you when you register on our site, place an order, subscribe to a newsletter, enter information on our site, or provide us with feedback on our products or services.</p>

      <h2 class="text-lg font-bold mb-4">How do we use your information?</h2>
      ...
      <h2 class="text-lg font-bold mb-4">How do we protect your information?</h2>

      <p class="mb-6">
        We do not use vulnerability scanning and/or scanning to PCI standards. <br>
        An external PCI compliant payment gateway handles all CC transactions. <br>
      ...
      <h2 class="text-lg font-bold mb-4">Do we use 'cookies'?</h2>
      ...
      <h2 class="text-lg font-bold mb-4">Third-party disclosure</h2>
      ...
      <h2 class="text-lg font-bold mb-4">Third-party links</h2>

      <p class="mb-6">We do not include or offer third-party products or services on our website.</p>

      <h2 class="text-lg font-bold mb-4">Google</h2>
      ...
      <p class="mb-6">
        ...
        <br><strong>We have implemented the following:</strong><br>
        <ul><li>Demographics and Interests Reporting</li></ul><br>
      ...
      <h2 class="text-lg font-bold mb-4">California Online Privacy Protection Act</h2>

      <p class="mb-6">CalOPPA is the first state law in the nation to require commercial websites and online services to post a privacy policy. The law's reach stretches well beyond California to require any person or company in the United States (and conceivably the world) that operates websites collecting Personally Identifiable Information from California consumers to post a conspicuous privacy policy on its website stating exactly the information being collected and those individuals or companies with whom it is being shared. - See more at: http://consumercal.org/california-online-privacy-protection-act-caloppa/#sthash.0FdRbT51.dpuf</p>

      <h2 class="text-lg font-bold mb-4">According to CalOPPA, we agree to the following:</h2>
      ...
      <h2 class="text-lg font-bold mb-4">How does our site handle Do Not Track signals?</h2>

      <p class="mb-6">We honor Do Not Track signals and Do Not Track, plant cookies, or use advertising when a Do Not Track (DNT) browser mechanism is in place.</p>

      <h2 class="text-lg font-bold mb-4">Does our site allow third-party behavioral tracking?</h2>

      <p class="mb-6">It's also important to note that we do not allow third-party behavioral tracking</p>

      <h2 class="text-lg font-bold mb-4">COPPA (Children Online Privacy Protection Act)</h2>

      <p class="mb-6">When it comes to the collection of personal information from children under the age of 13 years old, the Children's Online Privacy Protection Act (COPPA) puts parents in control. The Federal Trade Commission, United States' consumer protection agency, enforces the COPPA Rule, which spells out what operators of websites and online services must do to protect children's privacy and safety online. <br> We do not specifically market to children under the age of 13 years old.</p>
    </div>
  </section>
</template>
